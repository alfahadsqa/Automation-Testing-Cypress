describe('first project' , () =>{
    it('Notice delivery Test', () => {
        ...
        cy.get("#mat-option-70 > span").click()
        ...
        cy.get('.mat-simple-snack-bar-content').should('have.text', 'true')
        cy.wait(3000)
        cy.get("#mat-select-value-13").click()
        cy.get("#mat-option-121 > span").click()


        //Verifying Global Notice configuration 
        cy.get('#k-grid4-checkbox0').click()
        cy.get('.pl-15 > .grid > .col > .jds-btn').click()
        cy.wait(3000)
