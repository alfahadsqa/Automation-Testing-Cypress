...
pipeline {
    ...
    parameters {
        string(name: 'SPEC', defaultValue: 'cypress/e2e/Tests/**', description: 'Ej: cypress/e2e/Tests/*.cy.js')
    ...
    //         publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: 'allure-report', reportFiles: 'index.html', reportName: 'HTML Report', reportTitles: ''])
    //         deleteDir()
    //     }
    // }
}
